...
<p>Also, I should have mentioned this yesterday: I <em>did</em> go on to rewrite my little exercise in Haskell. The exercise takes an image, messes with it, saves it to a file, draws it on the screen thirty times over the course of fifteen seconds, and exits. You can look at my <a href="/media/sdl_exercise_1.cpp">C++ source code</a> and <a href="/media/sdl_exercise_1.hs">Haskell source code</a>. They're almost exactly the same. Both consist of a quick wrapper around the SDL_Surface manipulation and a list of SDL commands to execute. Neither does much error checking. The Haskell one has significantly fewer lines, but they're about the same in file size. When I ran them, I used my avatar image from this site as the image to mess with. It looked pretty cool.</p>
