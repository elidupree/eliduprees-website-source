...
<p>By doing this, Alex gives Brett a gender label. But this label isn't sex, it isn't assigned gender, and it isn't gender identity. There are a few different terms for this kind of label: we might say "Alex <strong>reads</strong> Brett as female", or "Brett <strong>passes</strong> as female (to Alex)". If Brett made this happen on purpose, by choosing the right clothing and body stuff for zemself, then we say, "Brett is <strong>presenting</strong> as female".<footnote(( People can change almost any of these "gender cues" from if they want. They can dress in different clothing. They can wear wigs, binders, and breast forms. They can learn to speak in different voices. There are various ways to change the body itself, too. However, these things aren't always related to gender. They only become "gender presentation" if the person is making them about gender on purpose. And you don't have to change them &ndash; it still counts as "gender presentation" if you present as the same gender every day, as long as it is intentional in some way.))> </p>
