...
<p>So, there's this thing called "sex".<footnote((Actually, there are two things called sex. Here, we're talking about the one that's used to classify humans and other animals. <a href="/blog/sex">I'll talk about the other one in a different post.</a>))> In the case of humans... well, humans are diverse creatures. Some of them have vaginas, and some don't. Some have penises, and some don't. Some develop lots of facial hair when they reach puberty, some develop breasts, some have their voices deepen... and some don't. By a quirk of biology, most of these attributes are strongly correlated with each other, so we've grouped them all into two convenient little boxes. There's the box of deep voices, facial hair, and penises (and a bunch of other things), which we call the "male sex", and the box of breasts and vaginas (and a bunch of other things), which we call the "female sex". So if I have a human, and I ask a biologist what sex that human is, then the biologist will look at those attributes. If they all fit in the "male" box, the biologist will tell me that the human is male. If they all fit in the "female" box, the biologist will say female. If the human's attributes don't fit neatly into a box, the biologist will have to use a more sophisticated theory.<footnote((If a person is born not fitting completely into either box, the term for that is "intersex", as in "that person is intersex". People can also change many parts of their bodies by choice, later in life, but it's not conventional to call them "intersex" unless they were born that way.))></p>

<p>"Sex" is a biology term. Technically, it only refers to an individual's reproductive role. The other associated traits are called "secondary sex characteristics". In common usage, people say "sex" to refer to both, and most people don't know about any of the more sophisticated theories.</p>

<p>There's another thing called "assigned gender". When a baby gets born, everybody around it usually looks at its genitals and either says "It's a boy!" and starts giving it toy trucks, or says "It's a girl!" and starts giving it dolls and frilly dresses. When they do that, they're assigning the baby a gender. The baby usually doesn't get any choice in the matter. If its genitals don't look how the people expected, then they probably do weird medical tests to decide which gender they think makes more sense for it.<footnote((And they often also perform unnecessary surgery to make the baby more like they think it's supposed to be. What a bunch of assholes.))> Giving people different toys because of what gender you've assigned them is a form of <strong>sexism</strong>. Because our society is so sexist, people of different assigned genders often end up experiencing the world in significantly different ways.</p>

<p>There's another thing called "gender identity". For one reason or another, some people have an innate sense that they <em>are</em> a specific gender. Since I don't feel that way myself, I have no idea what that's like, but it seems to be really important to some people, so I generally acknowledge that it is a thing that exists and is important. There are a lot of things that exist and are important even though I don't know how they work. Since gender identity is so important to people, it <em>also</em> has a huge effect on how they experience the world.</p>

<p>When people use words like "man", which of these things are they talking about? People hardly ever look at someone's genitals, or zir birth certificate, before using those words for them. They usually don't ask zem about zir identity, either. </p>

<p>Imagine this: Alex points that Brett and asks, "who's that girl over there, wearing the fuzzy hat?". How did Alex decide to call Brett a "girl"? Ze probably looked for external cues. Ze might have looked for things related to sex, like facial hair or chest shape. Ze might also have looked for other things, like clothing and hair length.</p>

<p>By doing this, Alex gives Brett a gender label. But this label isn't sex, it isn't assigned gender, and it isn't gender identity. There are a few different terms for this kind of label: we might say "Alex <strong>reads</strong> Brett as female", or "Brett <strong>passes</strong> as female (to Alex)". If Brett made this happen on purpose, by choosing the right clothing and body stuff for zemself, then we say, "Brett is <strong>presenting</strong> as female".<footnote(( People can change almost any of these "gender cues" if they want. They can dress in different clothing. They can wear wigs, binders, and breast forms. They can learn to speak in different voices. There are various ways to change the body itself, too. However, these things aren't always related to gender. They only become "gender presentation" if the person is making them be about gender on purpose. And on the other hand, they don't need to be <em>changed</em> &ndash; it still counts as "gender presentation" if you present as the same gender every day, as long as it is intentional in some way.))> </p>

<p>Maybe, when Alex said "girl", ze was only talking about how ze read Brett. But maybe ze was talking about gender identity, and ze simply assumed that Brett's presentation was meant to show that Brett had a female identity. Or maybe ze assumed that Brett was assigned female, or belonged to the female sex in some way. Maybe Alex doesn't know that there's a difference between these things. So, what did Alex really mean when ze said "girl"? The only true answer is that we don't know.</p>



<p>So, have I made my point yet?</p>

<h3>Part one and a half: No, I haven't!</h3>

<p>The thing is, even though I just wrote a lot of stuff about gender and sex and stuff, that isn't even the original reason I decided to scrutinize these words. I'm not saying it's not a wonderful reason to try to use more specific language, and to avoid overused, ambiguous terms like "woman" and "boy". But that's not the real reason that <em>I</em> have for avoiding those words.</p>

<p>After all, a person could say something like this:</p>

<blockquote>So what if people use those words to mean a lot of different things? Lots of people use lots of words ambiguously every day; that doesn't necessarily mean that you should avoid the words. It means you should use them correctly. And they're useful words, too: Think about how using the terms "trans man" and "trans woman" affirms trans people's identities, in a way that language like "FtM" and "MtF" don't. Truly "unambiguous" language would say things like "trans person who identifies as female" or "non-female-assigned person who identifies as female", which, to my ear, sound like they're raising a note of skepticism about that identity, rather than affirming it.</blockquote>

<p>Well, okay, hypothetical person. I like what you're saying. People's identities are generally more important than quirks of their history or biology. So, rather than saying "male-identifying", it's often better to say just "male". But since you want us to keep using the word "man" in particular, I'd like to know what exactly you mean when you say "man".</p>
...
<p>Yes you did. But what the heck is an adult, anyway?</p>

<h3>Part two: Age</h3>

<p>The same way I talked about in <a href="/blog/scrutinized-words-she-he">my post about <q>she</q> and <q>he</q></a>, there are two problems here. One has to do with <em>how</em> we decide what category to put people into. The other is the fact that we use an oversimplified set of categories in the first place.</p>

<h4>Passive exclusion</h4>

<p>Suppose I'm addressing an audience, on the topic of feminism, and I say "Women in this country face pervasive discrimination". There are two problems with that sentence. The first problem, of course, is that it's true. The second problem is that there are plenty of people who face the exact same kinds of discrimination I'm talking about, but whom I've left out. Discrimination doesn't magically start when you hit adulthood, so by saying "women", I passively excluded a lot of people.<footnote((You could argue that I'm not obligated to include everyone when I make a statement &ndash; after all, I have already excluded everyone who's not female, and hence left out a lot of people who face much worse gender-based discrimination than the average cis female person. However, that discrimination might work a bit differently than what I'm talking about at the moment. (In that case, perhaps I should make an <em>additional</em> statement explaining how similar kinds of discrimination can affect those people as well.) However, excluding people by age has very little to do with what I'm saying, so it is not justified. This is especially important because, as an adult, I have a lot of privileges that children don't.))></p>

<p><em>I decided to scrutinize these words because I kept catching myself saying things like that.</em></p>

<p>On a related note, think about the hypothetical person I was talking to. Ze didn't even notice right away when ze said "people" and really meant "adults". That's an easy mistake to make if you've internalized the notion that non-adults aren't fully people. Both this and the example from the last paragraph are examples of <strong>ageism</strong>. Ageism, as you've probably guessed, is any form of discrimination against people of a marginalized age group. In general, all people who are not yet adults (whatever an adult is) are a marginalized age group. (Ageism also includes discrimination against people who are much older, based on their high age. That's not what I'm talking about in this post, but I'd be wrong to leave it out of the definition.)</p>

<h4>Active discrimination</h4>

<p>Okay, now <a href="/blog/scrutinized-words-she-he">go and re-read my post about <q>she</q> and <q>he</q></a>, except this time, replace "she" with "child", "he" with "adult", and "the minority of people who don't fit in the gender binary" with "everyone who lives past the age of twelve". Go on, I'll wait.</p>

<p>When does a person become an adult? What the heck is an adult, anyway? It's just like the whole gender thing: Like gender, it's really, really important in society, and like gender, nobody can agree on what it really means.</p>

<p>As long as "man", "woman", "boy" and "girl" are our primary words for talking about people with genders (or sexes, or whatever), we're going to have problems. It's not just a problem because it makes it awkward to decide what to say when you're talking about someone who's fifteen years old. It's also a problem because it creates a politics around the age categories. It makes every healthy conversation about gender into a secret nasty conversation about age, and every healthy conversation about age into a secret nasty conversation about gender. Even if you think it's okay to view specific events as coming-of-age events, we have language like "You're a woman now" and "separates the men from the boys" to make it so that you can't just be an adult... you have to be an adult in a gender-binary way! And that's not the only terrible thing it does. Let's look at another example:</p>

<p>There's an issue where people call adult female people "girls", all the way up through their forties. Some people say it's bad because it reduces competent, independent adults to children.</p>

<p>Sure, that's bad... <em>if you were thinking of children as "lesser" in the first place.</em></p>

<p>Think about the schoolyard insult "You hit like a girl". It's pretty obvious how sexist that is. It's not sexist because you're telling a male child that ze's weak; it's sexist because it's built around the assumption that female children suck at hitting because they're female. (Of course, it's also an insult, and you shouldn't be insulting people for no reason anyway, so it's bascially a bad idea on both counts.)</p>

<p>Now think about the statement that calling an adult a "girl" is infantilizing. It's <em>true</em>, just like it's true that "You hit like a girl" is an insult. People call adult female people "girls" because they think of female people as lesser and also think of children as lesser. But if you call out the sexism and not the ageism, you're just like the male child who yells back "I do NOT hit like a girl!" and leaves the basic, sexist assumption intact.</p>

<p>Like I said in the <q>she</q>/<q>he</q> post, that's only a symptom of the underlying disease. The disease is the fact that our language pushes us to judge people based on their age whenever we mention their gender.</p>
...
<p>If you said "women", go find a buzzer so that you can make an annoying buzzing sound to mark your incorrect answer. The group affected is <strong>people with functioning uteruses</strong>. A lot of people with functioning uteruses aren't adults, and not all people with functioning uteruses are female-identifying. Of course, there's nothing stopping you from talking about how sexism affects legal abortion rights campaigns <em>because of the strong correlation between</em> functioning uteruses and female gender roles, but by saying "people with functioning uteruses", you have neatly avoided all the passively ageist and cissexist language. It's a lot of syllables, I know, but if worst comes to worst and you have to say it over and over again, you could always shorten it to "uterus-havers" or something.</p>
...
<p>Also, I should have mentioned this yesterday: I <em>did</em> go on to rewrite my little exercise in Haskell. The exercise takes an image, messes with it, saves it to a file, draws it on the screen thirty times over the course of fifteen seconds, and exits. You can look at my <a href="/media/sdl_exercise_1.cpp?rr">C++ source code</a> and <a href="/media/sdl_exercise_1.hs?rr">Haskell source code</a>. They're almost exactly the same. Both consist of a quick wrapper around the SDL_Surface manipulation and a list of SDL commands to execute. Neither does much error checking. The Haskell one has significantly fewer lines, but they're about the same in file size. When I ran them, I used my avatar image from this site as the image to mess with. It looked pretty cool.</p>
