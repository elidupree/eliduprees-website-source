...
No mischievous person can be a time traveler &ndash; or rather, no person can use time travel without first making themselves sufficiently non-mischievous. The key to understanding how time travel works is to understand what it means to be "sufficiently non-mischievous".
...
A time travel defense network is a loose-knit organization where no one, not even members, knows the entire membership list. Each member stays in regular contact with a dozen or so other members. If any member stops reporting in &ndash; perhaps because they were killed by a time traveler &ndash; their contacts raise an alert and investigate. If they conclude that the disappearance was caused by a time traveler, they attempt to cause paradoxes. Thus, any attempt by a time traveler to kill a network member is much more likely to cause a paradox, and thus much less likely to be possible.
