...
“Hey! Who told you?”
Reverse.
- A conversation with a short-term reverser

The power of a reverser is the power to gather almost any information and succeed at almost any task on the “first” try. Short-term reversers can travel anywhere they want, bypass almost any security, and practically read people’s minds with without them ever being aware that it happened (as illustrated by the quote above). Long-term reversers are much less effective at gathering information in the short term, but they have an information-related ability that is potentially even more dangerous: if there is any information that they will ever learn, they might already have it. 

Short-term reversers usually display enormous skill in manipulating people. They gain so much experience with how people respond to different actions that they often know just the right thing to say even without using their powers.

A careless short-term reverser is easy to identify by the fact that they succeed at everything they try. Of course, you shouldn’t rely on this, because a short-term reverser can easily hide by intentionally failing at things sometimes. Fortunately, another part of their ability is less easy to hide: they tend to stumble or become disoriented during their replacement events, because the body they return to isn’t in the same position as the body they return from. A person who is very fortunate and can easily get help from others might only be a luck manipulator, but if they also stumble frequently, it is clear evidence of a short-term reverser.

Some short-term reversers are a rare variation who can bring back not only their mind and memories, but also their body and possessions. Such reversers can essentially teleport any distance in an instant, and instantly acquire objects from almost anywhere. Since they can’t duplicate objects, any object they bring back disappears from its original location. This gives them additional special strategies: they can remove supports from structures, or even break an object and then take pieces of it back to make it break spontaneously in the past. This type of reverser is theoretically much more dangerous: imagine falling into a pit as the ground disappears under you, or walking past a building and having a ton of bricks fall from the roof onto your head. However, in practice, any short-term reverser who wants to kill a non-time-traveler can do so. These reversers are also much easier to catch. They can’t avoid getting a reputation for teleporting and having objects move strangely around them, and they must eat enormous quantities of food to replenish the energy their body spends in their alternate futures.

Long-term reversers can’t be spotted in the same ways that short-term reversers can, because they have too few replacement events to be recognizable as a pattern. Instead, you can identify long-term reversers by the fact that they have unusual knowledge of future events and spend lots of time and effort planning for them. Long-term reversers collect so much knowledge and so many experiences that, even if they’re very careful, they can’t always keep track of which knowledge came from the current timeline and which knowledge came from their alternate futures. This is especially evident in their relationships with other people: they may seem to think of someone they just met as an old friend.

Counter-Strategy

For short-term reversers, the most important thing is how well you can resist their “mind reading” abilities. If their limit is only a few seconds, then at least you will know when they have had the chance to interrogate you. If their limit is longer than that, it gives them enough time to step out from behind a corner, say something to you, observe your reaction, and reverse the whole thing.

Theoretically, you could just hold a poker face no matter what they say to you. However, you not only need to hide your thoughts - you need hide the fact that you have something to hide. If an experienced short-term reverser starts investigating you in earnest, you have already lost. Your best bet is to develop a consistent cover story that is as uninteresting to your enemy as possible. For instance, you could spend most of your time complaining about something that your enemy doesn’t care about, and use that as a response to almost any question. If the reverser has never met you before, you might be able to make them think that you show everyone a poker face normally, but remember that the reverser can also learn about you by questioning other people who already knew you. Anything you plan to fake in front of the reverser, you should also fake in front of everyone else.

Never answer emails promptly. Always wait out your enemy’s time limit before responding. It doesn’t matter who the emails say they’re from - your enemy can easily access other people’s email accounts if they want to. Don’t write down any of your plans, and don’t reveal them to anyone who your enemy might have contact with. Don’t store any weapons in any place that your enemy would even think of looking, and remember that your enemy can search an entire room in a single instant without anybody noticing.
...
I once knew a time-traveler-hunter who liked to tell a story of killing a long-term reverser through an especially elaborate scheme. On the day he met her, she gave him a message that she had memorized. She claimed that he had told this to her in the future, and that he had promised that it would convince his past self to cooperate with her plans. The message did seem very convincing - until he noticed that it contained a personal duress phrase that he had never told to anyone else. When he examined the wording closer, he found a coded message from his future self, listing her vulnerabilities and instructing himself to play along until he found an opportunity to kill her.

This story, though it may potentially be true, is not meant as a model to be repeated, but as an inspiration to what strategies may be possible. The same trick is unlikely to workplace, but if you are always thinking of new ideas, you just may come up with something that will work.
...
Anyone who has learned basic world history knows how dangerous paradox cloners can be, since the entire scientific colony on the asteroid Ceres was destroyed in an instant by a single cloner. If a cloner of the same type were to appear on Earth, Earth’s population could be destroyed as well - or worse. Any sign of paradox clones should be treated with the greatest possible caution. Fortunately, most paradox cloners have limitations that would prevent them from causing such a destructive event. 
The basic rules of time travel are as follows: Suppose a cloner attempts to return from time Beta to time Alpha. If there’s something in the way at time Alpha, nothing happens. Otherwise, the universe resets to time Alpha, and a clone appears at time Alpha. This general process has many variations. Before you confront a cloner, there are some important questions to ask. 
...
Question two: Is cloning reversible? Obviously, a clone continues existing even if it prevents the original from going back in time to create it. However, does it still appear if someone goes further back in time to prevent the cloning event? In the case of reversible cloners, the answer is “no”: the clone-appearance event is bound to time Alpha, and any time travel that resets the universe to before time Alpha removes the clone-appearance event. This makes reversible cloners much safer. In the case of the thankfully-much-rarer irreversible cloners, the clones appear no matter what, even if someone moved a solid object into the location they were to appear.

The Ceres cloner was free-moving and irreversible. Historians still disagree on exactly what happened, but the most widely accepted theory is as follows: While the cloner was still experimenting with her power, she accidentally cloned herself into the same place as one of the other scientists, killing both of them. Unwilling to accept what happened, she repeatedly tried to go back in time again and prevent it, but each time, she failed, and only ended up creating more clones and more problems. When the colony was crowded with hundreds of clones, the scientists started realizing the danger, but by that time, the task of convincing each and every clone to stop trying was impossible. The only thing that could stop the runaway clone pile-up was for every clone to die before they had the chance to use their powers. This happened in the way we observed from Earth: the moment she got her powers, the asteroid colony exploded under the pressure of so many overlapping bodies, and millions of dead clones went spiraling into space. The only mercy was that the destruction was confined to the asteroid, because no shuttle to return to Earth was available at the time.
...
The most difficult type of cloner to fight against, however, is a cloner who efficiently cooperates with their clones. Smart cooperative cloners keep dozens of “backups” - clones that hide and don’t use their powers unless the main group is attacked in some way. A single cooperative cloner becomes an entire community of long-term reversers who not only watch out for each other, but also have unlimited material resources.
...
1. Make it look like some of the clones have secretly betrayed the others. When the others learn of this, they will go back to prevent the creation of the traitors - they likely won’t investigate too long, for fear that the traitors will go back first. This won’t destroy the whole group, but they will be more cautious about creating extra clones next time, which will give you an advantage in the next timeline.

2. Make it look like an important event happened just after the first appearance of any clones - an event that they would want to go back and a change in some way. Identify which clone wants to go back and fix it, then plant a bomb on that clone. If you’re lucky, the bomb will explode in the past and kill all the clones who are alive at that time.
...
“It should be possible to form a complete theory of human behavior, i.e., to predict from the hereditary and environmental givens what a person will do. However, if a mischievous person learns of this theory, he can act in a way so as to negate it. Hence I conclude that such a theory exists, but that no mischievous person will learn of it. In the same way, time travel is possible, but no person will ever manage to kill his past self.” - Kurt Gödel

No mischievous person can be a time traveler - or rather, no person can use time travel without first making themselves sufficiently non-mischievous. The key to understanding how time travel works is to understand what it means to be “sufficiently non-mischievous”.

Consider Jane-the-hypothetical-beginner-time-traveler. Jane is sitting alone in a room at 10:00, watching TV. Jane says to herself, “I’m going to wait until 11 o’clock, then go back to right now and tell myself what was the last thing I saw on TV.” Jane looks to see if a copy of herself is going to show up, but nothing happens.

Jane didn’t think through the plan well enough. Once she saw herself arrive from the future, what was she going to do? Maybe she was going to get curious about what would happen if she didn’t go back. Even if she did go back and experience the hour a second time, she might get curious about what would happen if she didn’t repeat what she remembered herself saying from the first time around.
...
In the second example, Jane created a successful Intent. In the first example, Jane created a failed Intent that would have led to paradox. When a time traveler creates an Intent successfully, they voluntarily give up any mischievous inclinations they might have, in order to receive the benefits of time travel. Once the Intent is created, the time traveler is bound by the Intent until there is no remaining way that paradoxes could be created. (Besides creating paradoxes, the other way for an Intent to fail is if the time traveler doesn’t have a strong enough will to bind themselves to it. For instance, a cigarette smoker could not necessarily say, “I’m going to give up cigarettes for a week and then go back in time and tell myself I managed it”, even if they weren’t tempted to mischief.)

Now that you understand this much background, it is possible to explain the basic counter-strategy.

The basic counter-strategy is to disrupt a time traveler from forming valid Intents. Imagine that a soldier is spying on Jane through a window. The soldier intends to watch and see if the second Jane appears, and if one does, to shoot both of them at 10:30. In this scenario, neither of Jane’s Intents will work, since both would lead to a paradox. When Jane notices that it isn’t working, she might try various other things, and might eventually succeed with something like, “and the second Jane will be hidden behind the dresser when she appears.” At that point, Jane could infer that the cause of the paradox came from someone watching at the window.

Note that, unlike Jane’s Intent, the soldier’s intent is NOT magic. If the soldier was the type who would change their mind at 10:29 and not shoot, the time travel would work normally. The process that regulates people’s intents-to-use-time-travel treats non-time-travelers as deterministic machines, and ignores any intent that doesn’t involve time travel. The soldier will never see time-travel events happen as an immediate response to the soldier’s mental decisions, because - for any decision - it was already true that the soldier was going to make that decision, so the time travel had already taken it into account.

There is one possible exception: Theoretically, if Jane’s time travel power used a machine that could be stolen, the soldier could form a supernatural Intent to steal the time machine and then use it for some other purpose. If successful, that could be a very effective strategy. However, using time travel against other time travelers is outside the scope of this book.

Note also that most time travelers aren’t aware of how this process works. When an ongoing Intent forces them to carry out a certain action or avoid a certain action, they usually assume that they simply made the choice at the time. (Or they might hold a superstitious fear that the universe would punish them if they caused paradoxes.) Time travelers cannot recognize a successful Intent until they observe its physical consequences. If an Intent fails, they gain no information about why it failed. However, if they understand the process well enough, they can still gain a great deal of information by trying a variety of Intents to see which ones work and which don’t.

By making the right plans, you can be like the soldier, but disrupt a much wider variety of possible Intents. If you are planning to respond to a time traveler’s actions by causing a paradox on purpose, you will cause the failure of any Intent that would lead to you noticing the time traveler do those actions. The most severe disruption would be if you planned to cause a paradox if you noticed any time travel at all. DO NOT DO THIS. Although it would hinder time travelers a great deal, it would not stop them from forming an Intent to kill you before you cause any paradoxes.

Causing a paradox on purpose can be done in many ways, not just by killing time travelers. It is wise to collect future knowledge that can be used to cause paradoxes. For instance, if a time traveler brings back a photo of a unique object in the future, destroying that object in the present would cause a paradox - unless the time traveler used their future knowledge to bring back a falsified photo on purpose. If possible, gather your future knowledge from less experienced instances of the time traveler, who are more likely to give away reliable future knowledge carelessly.

Note that you can never actually cause a paradox in the main timeline. However, you could think of it this way: whenever the universe judges an Intent, it creates an alternate future timeline in which the Intent is carried out. Your choice of whether to cause paradoxes in that alternate future timeline determines whether the Intent succeeds. 

I can now explain the reason for the memetic hazard warning above. Reading this book increases the chance that, in some alternate future, you will attempt to cause paradoxes. A very smart time traveler might be able to identify you as the source of the paradoxes and kill you on purpose. A less smart time traveler would just try different plans until one succeeds, and might stumble upon one that succeeds because it kills you by accident. 

The key to fighting against consistence time travelers is to cause paradoxes for actions that harm you, while tricking your enemies into taking non-paradoxical actions that help you.

Time Travel Defense Networks

This book cannot hope to give a full description of how to organize or operate a Time Travel Defense Network, given that most existing networks have a policies-and-procedures document that is longer than this book in its entirety. However, a basic overview is as follows.

A time travel defense network is a loose-knit organization where no one, not even members, knows the entire membership list. Each member stays in regular contact with a dozen or so other members. If any member stops reporting in - perhaps because they were killed by a time traveler - their contacts raise an alert and investigate. If they conclude that the disappearance was caused by a time traveler, they attempt to cause paradoxes. Thus, any attempt by a time traveler to kill a network member is much more likely to cause a paradox, and thus much less likely to be possible.

(If the system has too many false-positives, by reacting to disappearances that are not caused by time travelers, it becomes more like the dangerous “always cause paradoxes” strategy. If it has too many false-negatives, by allowing time travelers to kill members in a way that doesn’t look like murder, the network risks being slowly wiped out. Choosing the right investigation rules is crucial, and each network does it in a slightly different way.)

Establishing a new network is a risky process that should only be undertaken by someone who doesn’t currently have the ill-will of any time travelers. An active enemy time traveler would find it much easier to simply kill the founding member(s) before they start recruiting.

A network spends most of its time in “defense mode”, only reacting to threats against its members and not attempting to disrupt time travel on a larger scale. Once network members identify an enemy time traveler, they watch the time traveler closely, study their goals and behaviors, and start planning for their next move. Eventually, the members may go into “attack mode”. In “attack mode”, they start causing paradoxes selectively to steer the time traveler into a trap.

Trapping a Time Traveler

The difficulty of setting a trap depends on how defensive the time traveler is.

A low-defense time traveler goes on missions without even checking in with their future self first. Low-defense time travelers can be killed normally. They form an Intent to go on the mission, the Intent is valid because they die in a non-paradoxical way, and then it happens.

A medium-defense time traveler always checks in with themselves. If you use the same tactics against them, they just choose not to go on any of the missions where you would succeed in killing them. Against a medium-defense time traveler, try to poison them just before they return, using a poison that has no antidote. They will be able to report in, but unable to find any Intent that leaves them alive after that.

A high-defense time traveler checks in with multiple future versions of themselves on a staggered basis, including ones from weeks in their future, if not months or years. Using a poison that takes months to show its effects might work, but usually, allowing a time traveler to remain active for that long is unacceptable. The weakness of a high-defense time traveler is that establishing the required time loops is extremely difficult, and attacking a Time Travel Defense Network while using high-defense time travel is essentially impossible. The counter-strategy is to start causing more and more paradoxes until the time traveler is forced down to a medium-defense level.

If you have access to mind control, a special strategy is available. Ambush the time traveler and control them, then send them back to give a false report that their mission was successful. In the case of high-defense time travelers, send them back however many times your enemy’s protocol requires. Then have them return to you and submit to being killed. If you don’t have mind control, it may be possible to approximate this strategy using shapeshifting or false memories, but not if your enemy has prepared for them.
...
Long-leapers are fundamentally the most similar to paradox cloners, but they have special restrictions that make them appear to be consistent time travelers. A long-leaper is surrounded by a powerful luck-manipulation field that suppresses the butterfly effect and influences the universe to reach the same present that the long-leaper set out from. Furthermore, like a consistent time traveler, a long-leaper cannot go back in time until they form an Intent that allows the luck-manipulation field to do its job. (For instance, “let’s go back 70 million years and look at some dinosaurs” is fine, but “I’m going to bring back this bomb and blow up the Earth in 1980” is not.) Long-leapers can return from the past, but they must return just after they embarked, not before.

If you find yourself fighting against a long-leaper in the long-leaper’s present, you have an ordinary opponent. They have a few special abilities, but none of them are exceptional:
1. They can gain extensive, accurate knowledge of history and geography without leaving any evidence.
2. They can spend days developing plans in the past without taking any time to plan in the present.
3. In some cases, they can teleport from place to place instantly, by going back in time and then returning in a different place.
4. In some cases, they can travel into the future, making themselves vanish (and thus be impossible to attack) for a period of time.

If, on the other hand, you are in a long-leaper’s past, the strategic considerations are much different. 

Because the future is already set in stone by the time a long-leaper sets out to attack you, your success or failure in the fight has no effect on your ultimate legacy. If your legacy is your primary concern, don’t bother learning about how to fight long-leapers from the future: instead, assume that you have been misled in some way. Assume that your enemy is not actually a long-leaper from the future, but some sort of trick. Behaving this way will give you the greatest advantage in the original timeline, the one before any long-leapers interfere.

If you care more about your immediate future than your ultimate legacy, go ahead and fight the long-leaper - it is usually an easy task. Since the long-leaper cannot do anything that would change the future too much, their actions are very limited. The more they antagonize people, the more they disrupt history. If a long-leaper has picked a fight with you, the most likely result is that they are swiftly defeated and escape back to the future (or die). Their luck-manipulation field actually works in your favor. You are free to make complex schemes and use risky strategies, just as if you had a normal luck manipulator on your side. (However, you must consider the usual caveats of that ability as well.)

Your one disadvantage is that your enemy may have powerful technology and weapons from the future. Consider trying to steal them and use them to your advantage. Don’t bother trying to keep them too long after your encounter, however: The luck-manipulation field will make sure that they soon stop working and are forgotten. Similarly, if you want to make sure that the long-leaper dies rather than simply escaping, you need a foolproof plan, because the luck-manipulation field will prefer that the dead body isn’t left in the past as evidence. One possibility is to poison them, so that they only die after returning to the future.

Being attacked by a long-leaper is normally extremely rare, but if you find yourself being repeatedly attacked by misguided long-leapers, you can take an additional preventative measure. If you decide to start attempting to cause “paradoxes” when they attack you, they are less likely to be able to go back in time to attack you in the first place. Adolf Hitler, although he was attacked by many time travelers in his youth, mysteriously stopped being attacked by time travelers near the height of his power, so it is likely that he used this strategy.
...
Oracles come in two types. Those who can see many possible futures are similar to personal time reversers. Those who see only one future, the one which will actually happen, are similar to consistent time travelers. Oracles have no counterpart to paradox cloners, since oracles and can never duplicate themselves.

Oracles are typically less dangerous than time travelers, because oracles can make mistakes, their planning time is not unlimited, and they can never be in two places at once. (Take note, of course, that “less dangerous than time travelers” is a very weak statement.) Consistent-oracles, compared with consistent time travelers, have no other advantages to make up for these weaknesses. Reverser-like oracles, on the other hand, have a major advantage over true reversers: they have no difficulty at all in predicting and avoiding their own deaths. If you make any normal attempt to kill a reverser-like oracle, the oracle will have already predicted alternate futures until they find one in which they survive.

There exists a possible counter-strategy for this. The one thing an oracle cannot predict is their own future predictions. That is, in each potential future an oracle sees, the oracle never makes another prediction. Thus, to kill a reverser-like oracle, wait until you see them using their power, then strike immediately. Since you only kill them immediately after they make a prediction, they never see you kill them in any of their other predictions - only the last one, which hopefully doesn’t give them enough time to react.
