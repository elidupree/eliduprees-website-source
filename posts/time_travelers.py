...
Oracles come in two types. Those who can see many possible futures are similar to personal time reversers. Those who see only one future, the one which will actually happen, are similar to consistent coilers. Oracles have no counterpart to paradox cloners, since oracles and can never duplicate themselves.
