...
stimulation_list = [
  ...
  simple_item ("pull off my clothes", 0, 2, 1, 4, small, "This kind of requires my participation, but only a little.", {"weight":3, "no_self": True}), # no_self because there's already a participation version
  simple_item ("tickle me", 2, 5, 0, 3, immediate, "TODO description", {"weight":2, "no_self": True}),
  ...
  simple_item ("pinch/twist my nipples", 1, 6, 0, 3, immediate, "TODO description", {"weight":2}),
  ...
  simple_item ("scratch the soles of my feet", 4, 7, 0, 1, immediate+1, "Like tickling, this doesn't cause <em>pain</em> per se. It does cause an overwhelming sensation that my mind has trouble dealing with.", {"weight":0.5}),
...
participation_list = [
  simple_item ("strip naked", 0, 1, 0, 3, small, "TODO description", {"weight":2}),
...
bondage_medium = medium
bondage_long = long
bondage_list = [
  brief_item ("tied spreadeagled on the bed", bondage_medium, "", {}),
  brief_item ("tied to a chair, with my legs apart", bondage_medium, '''Sometimes I tie my legs to my computer chair and imagine someone's forcing me to play computer games, with additional "punishments" when I lose at them.''', {}),
  brief_item ("hands tied behind my back", bondage_medium-1, "", {}),
  brief_item ("hands tied together above my head", bondage_medium-1, "This one's nice because it also makes my underarms very exposed.", {}),
  brief_item ("legs tied together at both the ankles and the knees", bondage_medium, "Whenever I'm tied up, I get an extra surge of vulnerability whenever one of my automatic movements is blocked. Tying my legs at the knees blocks a <em>lot</em> of automatic movements that I don't even think about normally.", {}),
  brief_item ("big toes tied together", bondage_medium, "Like with the knees, tying my toes blocks a lot of movements that I don't <em>expect</em> to be blocked.", {}),
  brief_item ("ankles and toes tied to a bed frame above, with my body face-down", bondage_medium, "Having my feet exposed and tortured isn't my <em>main</em> kink, but this position is great for it. It makes me feel so helpless. Not only am I unable to stop you, but it's hard for me to even see what you're doing.", {}),
  brief_item ("hands and/or ankles tied together loosely, so I can still walk but it's awkward", bondage_long, "This one is good if you want to keep me tied up for a while without getting uncomfortable, or if you want to force me to move around while partially tied up.", {"long_term": True}),
  brief_item ("ankles each tied to the same thigh", bondage_medium, "Note: We can't do the same thing with my arms, because I need to be careful about ulnar nerve problems from folding up the elbows.", {}),
  brief_item ("tied thoroughly to a rigid object (bed frame? pole?) so that I'm as immobile as possible", bondage_medium-1, "", {}),
  brief_item ("ankles tied to my waist so that I can't stand up all the way", bondage_long-1, "This could be part of a stress position. Or you could force me to walk around while I'm tied like this.", {"long_term": True}),
  brief_item ("nipple-clothespins tied to an overhead hook, so I have to stand on my tiptoes", bondage_medium, "", {}),
  brief_item ("nipple-clothespins tied to an overhead hook to wrists/thumbs/ankles/toes, so I have to keep holding up my arms/legs", bondage_medium, "", {}),
]
...
I've also listed "pleasantness" for sensations that can become intense, but are still fine when I'm tired. It uses the same scale. "Time" is on a more arbitrary 1-10 scale. The time listed for each thing is the <em>minimum</em> time commitment. (Most of them can go on for longer just by repeating the thing.) The exception is the bondage list, where the time is the maximum time I can comfortably stay tied that way.
...
function button (text, generators, parameters) {
  return $("<button>").css("display", "block").text (text).click (function() {
...
$("#kink_generator").append (
  ...
  $("<input>", {id: "max_time", type:"number", min: 1, max: 10, value: 10,}),
  "time",
  button("Generate something to do to me while I'm tied up", 
