...
<p>If you include the gender binary in every sentence you write, speak, or think, then it becomes part of your <cut>way of understanding people. You start judging people based on their apparent gender, even when it's mostly irrelevant. Obviously, that's a pretty silly idea. And given how much discrimination there is in our world, especially against humans who don't fall neatly into the gender binary (hi!), and against humans who fit neatly but fall on the "she" side, it's not just a pretty silly idea &ndash; it's a really terrible idea.</p>
