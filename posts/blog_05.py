...
<p>This afternoon, a reader asked me about how I use the word "neurodiversity". So I noticed that I hadn't explained it yet.</p>
...
<p>The first meaning is the idea that different people's brains work differently.</p>

<p>The second meaning is the <strong>neurodiversity movement</strong>. This says that brain differences don't just <em>exist</em> – they are natural and valuable.<footnote((A historical note: The word "neurodiversity" was first used in the autistic self-advocacy movement. Some people still use it to refer only (or mostly) to autism. "Neurodiversity" is obviously the right word for the broader ideas that I'm describing in this post, so if you don't think it means that already, I hereby steal it.))> It says we should support people with all different kinds of brains. Sometimes, brain differences come with problems, and we should find healthy ways to handle those problems. Sometimes, there are advantages to having a neurodiverse population, and we should make good use of them.</p>

<p>Our society labels some ways of thinking as "normal". When we talk about people who think in a "normal" way, we say they are <strong>neurotypical</strong>. When we talk about people who think in a way that's labeled "not normal", we say they are <strong>neurovariant</strong> or <strong>neurodivergent</strong>. These aren't rigid categories, though.</p>
...
<p>Neurodiversity means planning activities that appeal to introverts as well as extroverts. Huge, noisy gatherings appeal to some people. Small, quiet ones appeal to others. It means not rating "happiness" by measuring extroverted behaviors. It means not telling people what they are "supposed" to want.</p>

<p>Neurodiversity means not expecting that everyone can participate in every activity. Imagine you're hosting a party, or teaching a class, or running a conference. It's okay to propose a "fun" activity or an "icebreaker" game, but if someone says ze doesn't want to play, they don't have to. You must immediately accept that and move on, even if you don't think ze "has a good reason" to avoid the game. It means, when you're dividing up work, being ready to compromise and seek alternate solutions. Some things that are easy for you can be hard for others. It means not saying that a person is lazy if ze is too depressed to work, or that a person is selfish if ze can't do a certain task because of past trauma. It means accepting all of those things <em>even if ze hasn't told you exactly what the problem is</em>. It's not zir job to tell you zir psychological profile before you respect zem. Sometimes ze might not even be able to explain the issue in a way that you understand.</p>

<p>Neurodiversity means understanding that some things that don't hurt you can hurt others. You might be able to ignore flickering lights, or background noise, or <em>lack</em> of background noise, or the smell of perfume, or the presence of cats or dogs. For some people, those things are overwhelming, or interfere with their ability to function. Neurodiversity means accommodating other people's needs, even if you can't see those needs.</em>

<p>Neurodiversity means giving trigger warnings before discussing traumatic subjects. You usually don't know whether people are struggling with PTSD or self-harm or suicidal thoughts. Trigger warnings or content notices give them the chance to prepare, or avoid the topic when they need to. It means letting survivors <em>choose</em> when to engage, rather than bringing it up unexpectedly or avoiding difficult subjects entirely.</p>

<p>Neurodiversity means not making too many assumptions based on how people seem on the outside. It means not assuming a person is "stupid" because ze has language difficulties, or that ze is "immature" because ze gets upset when someone disrupts zir routine. It also means not assuming that a person <em>doesn't</em> have a mental disability just because you don't notice anything unusual about zem.</p>

<p>Neurodiversity means recognizing that brain differences are often good. Some brain differences are often labeled as "mental illnesses", "disabilities", or "disorders". However, it's up to each individual person to decide whether those labels fit. Neurodiversity means not calling a person's difference a "disability" unless ze identifies it as a disability zemself. It means not trying to "cure" someone if they don't ask for it. It means valuing the perspectives of autistic people <em>and</em> allistic (non-autistic) people, extroverts <em>and</em> introverts, trans people <em>and</em> cis people, people with strong empathy <em>and</em> people with no empathy, sexuals <em>and</em> asexuals, multiples <em>and</em> singlets, people with spiritual instincts <em>and</em> those without.</p>

<p>Neurodiversity means not judging people for their feelings, even if you find those feelings distasteful. It means not saying "pedophile" when you mean "child molester", because people don't choose who they're attracted to.<footnote((Also, as far as I've heard, most child molesters <em>aren't</em> pedophiles. They target children because children are easy targets, not because they have any particular attraction to them. And why are children easy targets? It's not just because they are physically smaller and weaker. It's because other adults already told them to be ashamed of sexual things, so they're less likely to report the assaults. And it's because other adults might not believe the children if they do report. This is especially true for neurovariant children. Child molesters often target neurovariant children because they know that neurotypical adults often don't believe or respect those children.))> It means not stigmatizing people for their anger or obsessiveness or lack of empathy, when the only real thing to judge is whether they actually hurt people or not. It means not writing people off as "attention-seeking", because when a person is looking for attention, there's usually a good reason for it.<footnote((People say this line a lot whenever a female teenager makes an ineffective suicide attempt. Usually, a person doesn't <em>do</em> that when ze doesn't have major problems in zir life. If you ignore zem or ridicule zem because ze's "just looking for attention", then you might be part of the problem .))></p>
