...
I will call a strategy "reasonable" if it is never unsustainable unless the opponent is more unsustainable. The idea is that of two reasonable strategies play against each other, the result should be sustainable.
