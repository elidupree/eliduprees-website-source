...
Promises are what makes the reader want to keep reading. But there are lots of different kinds of promises. Some are <cut>big and long-term: A mystery novel promises, "finish the book and I'll tell you how the murder happened!" But others are small and short-term: When a character asks a question, that promises, "read the next line and I'll tell you how the other person answers!" Every medium has its own variations. A news headline promises, "read the article and I'll tell you about this thing that happened!"
