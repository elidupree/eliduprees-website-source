...
[But Ones still had to avoid making changes that were big enough for Zeros to notice. So they spent their first loop starting to make the map, amount of exactly where everyone was at every time – a map that they had given to us in the zip file. This time, they had the sense to not repeat their mistake: Marvin-One only checked the cameras in places where he already knew he wasn't planning to go. He even wrote a script to download the camera history only at exact times, without accidentally looking at other times. And While Marvin-Zero was using the security cameras to find their route to the time machine room, Marvin-One was watching the security <em>server logs</em>, checking the exact times and cameras where Marvin-Zero accessed the footage.
...
[But one of the scientists hadn't been like the others. Reggie, who, before being shot, stayed seated and calmly wrote down something on a scrap of paper.]
