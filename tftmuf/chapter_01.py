...
Even then, they were obviously more than just an academic department. My office wasn't on-campus – it was in the old Riker Hospital building, which I'd thought was abandoned when Riker moved to a new, modernized facility four years earlier. But now, my new employers owned the entire building. And my paycheck came from a company called NeuroSci Innovations, which no one had ever heard of. I should have known there was something underhanded going on. But I was in a hurry to get a new job – I'd just been laid off at a dying tech startup. I was short on cash, and my new pay was good. <em>Suspiciously</em> good. Even a prestigious research university like ????? wouldn't normally have the budget to pay competitive, market rates for a computer graphics engineer. But that's what they were paying me. And I didn't say no to it.

An abandoned hospital wasn't a normal workplace for a software engineer. Even the commute was desolate – this region of ?????city [something-burg?] had never really recovered from the hurricane a few years back. People had lived in these destroyed homes once, but after the evacuation, most of them had seen the writing on the wall. Or in this case, the writing by the state scientific commission, about the severe flooding that would soon be commonplace, in these low-lying zones close to the ocean. Just about the only people left were the old-timers who would rather die in the homes they'd grown up in… and the few poor souls who were still in denial about climate change.
...
Inside, [????? it was only partly used/organized; a fungus creeping over a rotting tree] Some attempt had been made to clean up the first-floor treatment rooms and convert them into offices, but in many places, racks of unused medical equipment had simply been pushed into back corners to gather dust. The upper and lower floors were completely off-limits to us, the doors secured with electronic locks that had been retrofitted on by the new owners. ????? basically every door in the building had electronic locks and surveillance cameras all over the place ?????

Getting set up in the makeshift office was an adventure in itself. First of all, every single computer in the office had a physical blue-green color filter glued over the monitor. My new boss told me we were working on making an animated color pattern for some kind of psychology research, and the color filters were for "ethics". The pattern could theoretically have psychological effects on anyone who saw it, so the scientists didn't want to expose anyone except the intended test subjects. At least, that's what they'd told my new boss. So we were doing all the prototyping using color-swapped versions of the actual pattern.

"What happens if you look at it?" I asked, curious.

"I don't know, probably nothing. But they're huge sticklers for ethics. I thought they had to be joking, but some of the other guys looked at it, and they were fired before I got back from my lunch break. And they put the blue things on the screens the same day, so now you can't see it even if you put the right color codes in. <em>Ethics</em>," he scoffed, with a smile and shake of his head. And at the time, I laughed along with him. But in hindsight, it hits differently. It feels silly to have scoffed at that level of caution, given the much stricter precautions we needed later.

[Physical description of the pattern in blue/green, "it was kind of hypnotic, but like, not anything special"]

"What are the real colors?" I asked him once.

He chuckled. "Don't forget, I'm a programmer too. I know how programmers are. If I tell you the real colors, you'll want to look at it yourself. Call me a killjoy, but I'd rather keep my job." He was still smiling, but his eyes flicked to the surveillance camera watching over us. [????? guess we should just play along ????? the higher-ups (Fuller?) don't know how to work with a programmer, don't get things done too quickly because that'll increase their expectations – ?????]

<bigbreak>

[????? But my one flaw has always been that I can't look away from something once I get curious. I wanted to know what was on the locked-off floors, what all this security was for ????? I looked up the brand of the security cameras – the brand name on all of them was PanoptiLock, so I looked them up online. They sold expensive, high-tech security equipment, which looked great in the marketing videos – looked great if you didn't know how to search for opinions from actual security professionals. But I was plugged in the security community; I quickly found reviews pointing out all the rookie mistakes in PanoptiLock products. And in particular, all their security cameras shipped with the same default password. So I tried the password. Looking at the security cameras – I wasn't trying to be some sort of citizen-investigator, finding what they were up to, I was just doing it because I was curious. Because I <em>could</em>. What Reginald would later call "a profoundly amoral decision"]
...
[But what I found… Was nothing./Was notable for its failure to tell me anything. I saw workers and offices and medical equipment, chemistry labs where I overhear technical conversations beyond my understanding, but somehow, I could never catch anyone saying what the overall purpose of the place was.

[seemed like Reggie was in two places at once, I thought there was like an error or something]

[wrote out what was happening in each room, to try to get a sense of the big picture]
...
????? [I don't know what I would have done if time had just gone on, if Kayla hadn't forced the issue. Would I have tried to report them?

[hype Fuller somehow, followed by: the morning of the day when it happened, Fuller greeted me in the morning [chatting with Marvin in his condescendingly encouraging way]. I got up the courage to ask him "what do we actually do on the upper floors", as if it was just innocent curiosity. "It's very cutting-edge research you're supporting. Very technical" "try me, I can understand a lot of technical things". He explained, but indeed I couldn't understand it ("my eyes glazed over", but the internal version of that?). And then he clapped me on the shoulders, encouraging "keep up the good work". But then I had the presence of mind to look back at the security camera recording of the conversation, and saw how I reacted to his explanation – I could barely remember it at all, and he had a little smirk on his face, knowing full well that he could get away with saying whatever he wanted, because my brain would censor what he was saying]

<bigbreak>

This is what happened on [????? that day].

The ?????phorin Experiment was scheduled for 11:00 AM. At 9:56, two assistants unlocked the room where Kayla was being held, and told her she was to be taken to the experiment room. She complied. ????? Kayla, who was physically weak and stumbling, accidentally-on-purpose knocked one of the assistants into a ?????/Kayla was already physically weak and stumbling, and they knew this; this gave her an excuse to… ?????, vials of medicine shattered on the floor. Once they had strapped her into the fMRI machine, there was a hasty discussion. Dr. Fuller would be very angry, they agreed; it was imperative that this mess be gone before he learned of it. At 10:05, they agreed to split up – one to fetch replacements, the other to stay and clean. But as soon as the second assistant was alone, he realized he had no broom or dustpan to clear the broken glass. He glanced at Kayla; the must have known it would break protocol to leave her unattended. But she was fully restrained, lying motionless in the machine. Surely nothing would happen in just a few minutes. Surely Dr. Fuller's anger was a more urgent concern. This resulted in Kayla being left unattended for a total of six minutes, starting at 10:07. Only the room's security cameras could see her, and no one was monitoring them at the time – at least, not in the first timeline.

26 seconds from the moment the door closed, Kayla had fully freed herself from the restraints. Over the next 18 seconds, she rushed about the room, gathering the things she would need. By 10:09 AM, she was out the door. ????? sped down the hallway, following the exit signs to find ????? stairs.

And that's where I came in. At that moment, I just so happened to be <em>watching</em> the camera that she ran past. [Happened to glance through the other cameras right after I was done watching my conversation with Fuller?] Of course, at the time, I had no idea of what had just happened before that. All I knew was what I could see on the camera. And what I saw – the way my mind first interpreted it – was a frightened, teenage girl, wearing nothing but a hospital gown, holding a scalpel in front of her like a weapon. In the twelve seconds she was in view, she entered the lobby on the fourth floor, looked quickly around her, and crept to the nearest stairs, then disappeared downwards. My mind jumped to an explanation: she was a captive, trying to escape the building. I was almost right. Right in the ways that mattered.

I've done a lot of things I'm not proud of, but I'm proud of how I reacted in that moment. My worst fears about this place were realized, and I knew that if I didn't take action – immediately – then I would never forgive myself. If I did nothing, I thought, Kayla was going to step out of the stairs onto the lobby floor, in plain view of half a dozen people – people I could see from my view of the camera, who she couldn't see from where she was standing. [????? I couldn't just let it happen.]

I knew I had to [make sure my actions wouldn't be visible on the security cameras later, and it would be suspicious to only turn off the ones that would be relevant] At 10:10 AM, I turned off every security camera in the building, stood up, and sprinted for the stairs. [????? I turned off the security cameras – not just the ones we were going to go past, because that would be conspicuous, but every security camera in the building.] ????? Cracked open the door and called out softly, "this way! I can help you." ????? Face-to-face with Kayla for the first time.
...
I had been afraid that she ????? wouldn't know what I meant, that I would have to explain how it was that I didn't understand]. But I knew instantly that she had understood. The look that blossomed on her face wasn't confusion or frustration – it was <em>fear</em>. [She knew that she could keep trying to tell me these things, What she desperately needed me to know, but I would never understand, and then her time would run out. Or, as I later understood, that her only option was to do something horrible
