...
Inside, [it was only partly re-colonized, new electronic locks retrofitted over the existing doors,. The lobby, a vertical shaft rising through all seven stories, revealed some activity upstairs, some entire wings dark and unused. [????? it was only partly used/organized; a fungus creeping over a rotting tree] Some attempt had been made to clean up the first-floor treatment rooms and convert them into offices, but in many places, racks of unused medical equipment had simply been pushed into back corners to gather dust. The upper and lower floors were completely off-limits to us, the doors secured with electronic locks that had been retrofitted on by the new owners. ????? basically every door in the building had electronic locks and surveillance cameras all over the place; Marvin curiosity ?????
...
[Physical description of the pattern in blue/green, vaguely like a hypnotic spiral but no spiral, just wavy; "it was kind of hypnotic, but like, not anything special"]
...
But if I have one flaw, it's this: Once I get curious about something, I can't look away from it. [I wanted to know what was on the locked-off floors, what all this security was for / the locks just made me more curious / what was the Pattern, really? What was on the locked off floors? Why was it so important to keep everything secure? ?????]

[????? I started by googling the / I looked up the brand of the security cameras – the brand name on all of them was PanoptiLock, so I looked them up online. They sold expensive, high-tech security equipment, which looked great in the marketing videos – looked great if you didn't know how to search for opinions from actual security professionals. But I was plugged in the security community; I quickly found reviews pointing out all the rookie mistakes in PanoptiLock products. And in particular, all their security cameras shipped with the same default password. So I tried the password. Looking at the security cameras – I wasn't trying to be some sort of citizen-investigator, finding what they were up to, I was just doing it because I was curious. Because I <em>could</em>. What Reginald would later call "a profoundly amoral decision"]
...
[seemed like Reggie was in two places at once, I thought there was like an error or something ("you already know this is a story about time travel – go ahead, laugh")]
