...
????? A ragged flyer posted by the City Council, asking residents to report any sightings of urban coyotes or coyote scat, and warning them not to leave food out in the open. ????? towering, square brick face of the former Riker hospital building, very anonymous; and then the interior:] Some attempt had been made to clean up the first-floor treatment rooms and convert them into offices, but in many places, racks of unused medical equipment had simply been pushed into back corners ????? other floors locked off, basically every door in the building had electronic locks and surveillance cameras all over the place ?????
...
He chuckled. "Don't forget, I'm a programmer too. I know how programmers are. If I tell you the real colors, you'll want to look at it yourself"

[Physical description of the pattern in blue/green, "it was kind of hypnotic, but like, not anything special"]

[????? They got me set up on the actual work, which turned out to be this weird graphics stuff, I guess it was for some psychological research but I have no idea what it was for ????? they surveilled us to make sure we didn't look at the true-color version of the pattern, supposedly because of research ethics, but ????? told me they heard some of the other programmers looked at it and they got fired, and then the higher-ups put these color filters, guess we should just play along ????? "????? my direct boss, another programmer, didn't know what the deal was either, told me the higher-ups (Fuller?) don't know how to work with a programmer, don't get things done too quickly because that'll increase their expectations – ?????]
