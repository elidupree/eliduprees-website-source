...
Before I start to tell you what I remember, there's one thing I'd like to be clear about. I don't want you to think of me as "<em>the real</em> Marvin Fitzroy", or "<em>the original</em> Marvin Fitzroy", or anything like that. Your brain will want to, because I'm the one you know about – the one telling you the story. But time travel doesn't make those distinctions. Even the Marvins who don't exist anymore, they were just as real as I am.

And, because this is <em>my</em> version of the story, I can only tell you the part I know. For Kayla, it started six years earlier, when the scientists first started experimenting on her. For the scientists, it started another seven years before that, when they published the paper they didn't realize was about time travel. For Ontoh and Nochli, it started at a time that's harder to explain. Depending on your interpretation, you might call it "several months in the future", or "thousands of years ago", or – I hesitate to say this, because it still sounds absurd, even to me – "septillions of years ago".

But for me, it started when I was hired by the Neuroscience department at Whitney University.

[Hindsight has a way of making things obvious which you couldn't see when they were happening. I would have said I was just a ????? software engineer, looking for a job to tide me over after I was laid off at a dying tech startup. When I saw the job posting, I thought it looked pretty good: I'd basically just have to be a code monkey doing graphics work for some research, and they were paying megacorp rates for it.]

[I should explain, in case you don't know: In the tech industry, there was a huge [divide]. There were the megacorps, who could pay you huge salaries, because of their stranglehold on the market; and there was everyone else, who couldn't. Whitney was a prestigious research university, but they weren't a megacorp. With all their rich donors, maybe they <em>could</em> afford it, but I should have asked more questions.]

[But for better or for worse, I didn't. I did wonder what was up when my paycheck came not from Whitney University, but from a shell corporation called NeuroSci Innovations – but there were a lot of things to be busy with when starting a new job, and that one was easy to ignore.

What was harder to ignore was the location.

I <em>had</em> asked if I could work from home. [Even though most people assumed the COVID-19 pandemic was over, I was always a little uneasy about ?????, and working from home was more convenient anyway.] However, I was told that Dr. Fuller had insisted on having everyone at the physical office. [Circumspect remark on the consequences of this decision,] There's a cruel irony here: if they had let me work from home, I would never have {
...
If I couldn't work from home, I would have expected to get an office on the Whitney campus. Instead, it was in the old Riker Hospital building. I hadn't even known that that building was still being used for <em>anything</em>, after Riker had moved to a new, modernized facility four years earlier.
<bigbreak>

The scientists had picked the most miserable part of the city to work in.

My daily commute took me through the flood zone from the hurricane a few years back. This part of Masonburg had never really recovered. Once, these had been hotly desired single-family homes near the beachfront. Now, all you could see was empty shells, half of them sporting tattered notices that said the buildings were condemned. After the evacuation, most of the owners had seen the writing on the wall – or, in this case, the writing in the state scientific commission's report. The evidence was inescapable: In these low-lying zones close to the ocean, severe flooding would soon be commonplace. No one wanted to rebuild a home if it was just going to be destroyed again. Only a few had returned: the old-timers who would rather die in the homes they'd grown up in, and the few poor souls who were still in denial about climate change. The few repaired homes could not enliven the city again, only make a doomed last stand against inevitability.
...
"I don't know, probably nothing. But they're huge sticklers for ethics. I thought they had to be joking, but some of the other guys looked at it, and they were fired before I got back from my lunch break. And they put the blue things on the screens the same day, so now you can't see it even if you put the right color codes in. <em>Ethics</em>…" He smiled and shook his head.

At the time, I laughed along with him. But in hindsight, it hits differently. It feels silly to have scoffed at that level of caution, when, later, the precautions we'd needed were much stricter. And even though I'd thought he was charmingly cynical, neither of us had caught the actual lie: These scientists had never cared about ethics. To them, "ethics" was just a convenient excuse – an excuse that they could use whenever it meant doing what they wanted to do anyway, and put away whenever it didn't.
...
"Ah there, enjoying your work?" He greeted me with his authoritative smile – a smile that put you at ease, but made it clear he was in charge. With a close-trimmed beard and crisp button-down shirt, he was the epitome of "business casual". Before I could think of how to respond, he went on, "Of course you are, of course you are. You're contributing to <em>very</em> important research, you know."
