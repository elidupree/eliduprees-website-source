...
[Note: Fuller overheard the conversation until they mentioned "the Phrehibiphor experiment never happened", at which point he assumed the time-travel had started with Kayla escaping, and that he can revert it by stopping the escape [crossref t89edgf9 with chapter_aster_talk]]
...
[and then Fuller makes the call to Reggie]


[Wait he knew she was going to try to escape, that means he actually saw one of us or something, but how? [There's no cameras in They realize the covert recording; they decide to go to Aster's office early again and find the microphone. But wait, what if Fuller hears them looking for the microphone, and goes for the time machine? Well now that they think about it, they are already in a paradoxical future, so there's no limit to how much they can mess things up as long as (1) they go back again before their current time limit, and (2) they don't let anybody else use the time machine. So they go to Dr. Fuller's office first (with narration about the gun: in a fancy glass case, designed with the aesthetic of an antique hunting rifle but actually with modern gun features), take his gun (K takes it first but then Marvin is like "woah, that's not how you hold a gun! Oh Jesus, I never taught you to use guns in this timeline, I'll have to do it") and Marvin shoots him (and then says "I promise this won't have happened... Oh God, I shouldn't have shot him in the doorway, now we're going to have to step over his dead body. Uhhhh let's knock over that bookshelf so we can climb over him without stepping in his blood"), and THEN they lock down the building and find the hidden microphone, and also talk to Aster again]]

[As part of that, they need to make sure there's no paradoxes from the original KM, the KM who went shopping, or the KM who talked to aster (none of them departed before the current deadline, so we just need to prevent them from departing; the shoppers are easy because they probably left the building before the action, and the other 2 groups can be told explicitly)]

This time, Kayla says "let's talk to them [Aster] in person" and then she beats them up ("you told me the experiment would be safe!"… ["Okay but seriously we need to ask them about the science" and/or maybe they sent the video ahead so Aster's already watched it] "did you notice what she said before she died?" She said "what the hell are you? how long have you been following me? … what the hell you mean 'beep'" "this needs more investigation but I would rather it be done by one of me without a broken nose" eventually Aster excitedly repeats the phrase 'beep' and then dies)]

[During that: K:"she said, '<em>what</em> the hell are you?' That's not what I'd say to a human!" Marvin: "so, what, there's an invisible alien in that room with her? This is ridiculous [...] Anyway, if there's really an invisible alien, how come we are able to talk about it? If we still can't see it even with the [cyanosol], shouldn't we have forgotten that it exists?" A: "Well, maybe 'invisible alien' is just the closest concept that we are able to think about, and it's not really an invisible alien, but something different. Or maybe we DID see it and forgot it, but [like with the thing in the sky?] we forgot it so hard that after we looked away, we didn't know it was something we needed to forget"]
...
[Kayla "when we do the antidote experiment I want it to be the real me, the me who isn't going to be reverted" "but what if it doesn't work, isn't it less risky if we do it here in the doomed timeline?" [They figure out the plan where they wait around as backups for themselves and then go back in time to do the experiment]. Then they go back for a last time (and clean up their various arrivals?), run the script to do the replay attack (see below) and send the message to PoVs, and go hide in a random room waiting to cease to exist (PoVs don't see this last bit but get told that they were going to do it; PoVs need to know what room it is in order to not go there themselves)]
...
[By the end: the toxin that was released in the Kayla's brain was luckily a well-known chemical, and the antidote can be synthesized in less than 2 hours; they are ready to perform the antidote experiment]
