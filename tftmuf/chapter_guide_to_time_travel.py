...
+ 1: doomed KM start planning what to do. They realize that other KM are still showing up. They stop all the other KM from doing anything, wait until near the end, and then go back again to clean it up. Stowaway watches and doesn't interfere because it looks promising.
+ 2...: Doomed KM get rid of the other arrivals. (How? Maybe they send back blanks to replace them. Maybe they return to the start and deform the time machine to invalidate them. Maybe PoVs don't know)
Y: doomed KM send the message to us; stowaway following doomed KM. Stowaway sticks with doomed KM because they might change their mind and do something interesting, while PoVs are instructed to go straight to the time machine and will probably obey, and stowaway won't attempt to join them because they've already been warned about the mass discrepancy, so it would be extra paradox risk for nothing. Kayla 0 still suspected stowaway's presence in the corridor because of imprinting.
+ 1: we go back and send the message to ourselves; stowaway is now following us (and we experienced "no mass discrepancy" the first time)
…
??: Stowaway follows them to go shopping; considers stopping them from going outdoors, but is willing to take the risk because the shopping will help them succeed; follows them and is ready to stop/kill them if they are going to go within view of a Nochli.
...
+ 1: stowaway follows experimental group. Assistant texts fuller; Fuller attacks backups and dies; stowaway kills a bunch of people; backups make the plan
+ 2: experimental group replaced, stowaway trapped. Replay executed, leaving backups' history the same, so they synchronize with replayers' arrival. Ethics board convened, decides to cycle the time machine, ending day one