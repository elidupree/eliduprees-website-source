...
["We originally tried to ease new Marvin's into this, but experimentation determines that it's best to dump it all on you at once. We have ADHD; here is your medication. We used to give new Marvin's time to ease into the idea of taking it, but please start taking it immediately, the relief of our ongoing undiagnosed issues makes the recovery from the immediate trauma much easier to handle" ("for the last [week], we've basically been self-medicating with adrenaline"); the drug is Desoxyn, "it's literally methamphetamine. But we've tried a bunch of different medications and this was the most effective with the least side effects; we've already figured out the best dosage; it was difficult getting prescriptions because every time we had to be seeing that psychiatrists for the first time and of course because of the time travel, there was no record of how long we'd been taking it the previous medications, [but we managed it [maybe don't specify how they managed it], or maybe: it was impossible to get prescriptions within a reasonable amount of subjective time, because you're supposed to ramp up the dosage over weeks, but for us the weeks happen in days, so the ethics board authorized us to acquire the drugs, er, without a prescription. And then we did randomized trials to see which ones are best for me]"]

[A little unease about the reminiscence to Ontoh's words "try every drug", but also: less than X*24 hours ago, I'd had an untested, personality-altering drug injected directly into my veins; compared to that, a little methamphetamine didn't seem so scary. I resignedly swallowed the pill with a glass of water]

[Here, or later: all Marvins took their meds at the same times each day; you couldn't possibly miss a dose, because there were long rows of pillboxes with one pill labeled for each Marvin, and if you missed yours, other Marvins would notice and remind you.]
