...
posts = [
{
  ...
  "blurb_image": "/media/ravelling-wrath/illustrations/1-1.png?rr",
  "symbols": "nonaligned",
...
I didn't say that to <em>them</em>, though. The Stern God's people can be awfully uptight about that. Why do the Stern run the schools, anyway? Everyone says learning is the <em>Seeking God's</em> gift, so why's it the Stern who get to order us around? But I just kept quiet and pretended to care about their lecture, so they wouldn't keep me even later. On a normal day, it would've been fun to mess with them. But <em>Yali</em>.
...
[????yali got up to get healing supplies. the way she related to her house was like this: she kept everything organized, by habit, everything in its place. ?????wood furniture with the finish wearing off ???? dug around in a cabinet. ????? came up holding] a ceramic disk the size of her palm.
