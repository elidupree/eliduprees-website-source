...
That was true. A few years before, we had installed an electric refrigeration unit for the temple larder, which of course wasn't working now. But ????h had had the foresight to keep it stocked with ice anyway, praise the Waiting. So now it was one of the few places that could still store food cold.
