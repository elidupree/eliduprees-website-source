...
posts = [
{
  ...
  "blurb_image": "/media/ravelling-wrath/illustrations/21.png?rr",
  "symbols": "nonaligned",
...
Morrow was doing a lot better, too. Alchemist had invited him over to their house, and he got there towards the end of the day. He was still pretty depressed, but before long, Alchemist started texting me stories about him being his usual playful self, too. Unfortunately, I couldn't stop myself from sharing everything with Yali, and Yali absolutely did not want to hear live updates about Morrow. So Alchemist and I agreed to leave off until another day. But even as I put down my phone, I was just so happy that they were still going to be part of my life going forward, back here on Earth. And just a text message away at that.
...
I blinked. "<em>That</em> sure isn't what I expected you to say."
...
"I said, <em>that's enough!</em>" she snarled.
...
Finally, looking down, she mumbled, "How do you know what to say, when, when, when <em>you</em> feel bad? You always have something to say… How do you do it…?"
