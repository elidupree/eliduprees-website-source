...
<p>However, it would also make the comic harder to read. Ultimately, I decided that it wouldn't be worth the cost. As an author, I want my work to be as easy to read as possible. But as a viewer, if you only view things that have been made easy for you, you should be mindful of what you're missing.</p>''',
  ...
  },
  {
    "transcript": [
      ...
      (0, '''<span class="dialogue GREY">PAST GRANGER: Thank you, Mr Fudge. Sonorus!</span> {"Sonorus" is the incantation for a spell that makes the caster's voice loud, as one would use to make a speech.}'''),
  ...
  },
  {
    "transcript": [
      ...
      (3250, '''<span class="dialogue HARRY">PAST HARRY: Confringo!!</span> {Confringo is the incantation of the Blasting Curse.}'''),
...
<p>The other reason I made Time-Twisters is because some parts of my plot are anachronistic to the canon timeline, and I didn't want to bother restructuring the timeline to work out &ndash; instead I just handwave it by saying everything happens at the right time due to the damage done by Voldemort's Time-Twister overuse.</p>''',
  },
  {
    "transcript": [
      ...
      (1650, '''Two scenes show dead bodies labeled with bright magical writing written by Harry. One says "TORTURED MUGGLES FOR SPORT &ndash; TORTURERS WILL DIE". The other says <q>TRAPPED AND SOLD ELVES &ndash; SLAVERS WILL</q> and a past version of Harry is busy finishing the sentence.'''),
      ...
      (2500, '''We see Harry in class with two students casting nasty spells at Harry in class, while Professor <span class="dialogue GREY">Minerva McGonagall</span> looks the other way and continues lecturing.'''),
