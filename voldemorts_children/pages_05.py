...
PRESENT DUMBLEDORE: I believe that was the year he learned the power to split his soul, and once he was unkillable, he no longer needed our approval to take what he wanted. He no longer had to hide his true self.""",
  "annotation":"""<p>Dumbledore is more perceptive in the bottom half of this page than I had planned for zem to be. If I had more time to spend on this story, I would structure it so that you <em>see</em> what Dumbledore is describing, Dumbledore makes different assumptions, and then &ndash; because of what you already heard from Harry &ndash; you realize that Dumbledore's assumptions are incorrect.</p>
...
PRESENT DUMBLEDORE: We apprehended him and turned him over to the courts, thinking that would be the end of this tragic story.""",
  "annotation":"""<p>"The crow of the rooster is fatal to it" is a rather silly rule. I wouldn't have used it if the Basilisk was a major character. Here, it provides a anticlimactic solution to one of the books' major conflicts, just like when Voldemort was eliminated after zir attack on Harry's family.</p>

<p>As I was designing <i>Voldemort's Children</i>, one of my principles was that the characters should be forced to make decisions without having a convenient Dark Lord to oppose or seemingly wise adult authority figure to look to for guidance. Compared to the other choices the characters make, the choice of how to dispose of the Basilisk is an <em>easy</em> choice. That's why I'm willing to cover it in a quick and even silly way.</p>

<p>As a side note, the statue in the Chamber of Secrets is supposed to be a full-body statue and not just the head. I would have drawn it that way, too, if I was going to use it on more than one page. I was even thinking of drawing it from a dramatic angle, as if the reader was looking upwards at it. But since it only appears briefly, I decided to use an image that some people would recognize from the films.</p>""",
},
{
...
<p>Still, being a Death Eater is a significant risk factor for being killed by Voldemort. Voldemort personally kills about twenty named characters, and at least two of them (Peter Pettigrew and Severus Snape) were Death Eaters. The vast majority of characters aren't Death Eaters. So there's a pretty good argument that Death Eaters are <em>more likely</em> to be killed by Voldemort than people in general are. Voldemort is willing to kill anyone who is not useful to zem, so you're in danger of being killed if ze's even paying attention to you, regardless of which side you're on. In <i>Voldemort's Children</i>, I don't think <em>anyone</em> is useful to Voldemort.</p>

<p>Voldemort's tendency to kill people is the main reason I didn't have Lily call Voldemort "Wizard Hitler" on <a href="/voldemorts-children/43">page 43</a>. As far as history knows, Adolf Hitler didn't kill people personally (and ze certainly didn't have incredible powers). I <em>did</em> want to have Lily make a Muggle reference, though. (<a href="/blog/recommended-website-harry-potter-and-the-methods-of-rationality"><i>Harry Potter and the Methods of Rationality</i></a> has Harry say "Wizard Hitler", but it's a flippant comparison, while Lily's comparison is serious.)</p>""",
},
{
