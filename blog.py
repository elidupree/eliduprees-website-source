...
min_space_for_two_columns = post_padded_min_width + max_side_space - min_side_space_for_post
...
@media screen and (max-width: '''+str(min_space_for_two_columns+2*min_side_space_for_post)+'''em) {
  div.blog_stream { border-left:0; width:'''+str(post_padded_min_width)+'''em; }
  div.blog_right_bar { border-right:0; }
}
@media screen and (max-width: '''+str(min_space_for_two_columns+1*min_side_space_for_post)+'''em) {
