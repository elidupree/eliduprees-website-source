...
css.insert("div.blog_right_bar { display:inline-block; vertical-align:top; width:13.75em; padding:0.75em; border:1.5em solid gray; background-color:white; }")
...
blog = '''<div class="blog_page">'''+left_padding+'''<div class="blog_stream">
'''+fake_post()+fake_post()+fake_post()+fake_post()+fake_post()+fake_post()+'''</div>'''+right_bar+'''</div>'''
